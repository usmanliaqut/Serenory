...
import { Calendar, Clock, Shield, MessageCircle, Star, Users, CheckCircle, Phone, Mail, MapPin } from "lucide-react"
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-foreground">A Safe Space to Talk</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-muted-foreground mb-8 text-pretty animate-fade-in-up animation-delay-400">
                Schedule private sessions in a secure, confidential environment. Easy booking system that fits your
                schedule and needs.
              </p>
              ...
              <div className="relative w-full h-96">
                <svg viewBox="0 0 400 300" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect
                    ...
                    rx="8"
                  />
                  <rect x="60" y="60" width="100" height="8" fill="hsl(var(--primary))" rx="4" />
                  <rect x="60" y="75" width="30" height="6" fill="hsl(var(--muted-foreground))" rx="3" />
                  <rect x="95" y="75" width="30" height="6" fill="hsl(var(--muted-foreground))" rx="3" />
                  <rect x="60" y="85" width="25" height="6" fill="hsl(var(--muted-foreground))" rx="3" />
                  <rect x="90" y="85" width="35" height="6" fill="hsl(var(--muted-foreground))" rx="3" />
                  ...
                  <g transform="translate(60, 95)">
                    {[...Array(12)].map((_, i) => (
                      <rect
                        ...
                        width="18"
                        height="12"
                        fill={i === 5 ? "hsl(var(--primary))" : "hsl(var(--muted))"}
                        rx="2"
                      />
                    ))}
                  </g>
                  ...
                  <g transform="translate(220, 80)">
                    {/* Head */}
                    <circle cx="40" cy="30" r="20" fill="hsl(var(--primary))" opacity="0.8" />
                    {/* Body */}
                    <rect x="25" y="50" width="30" height="40" fill="hsl(var(--primary))" opacity="0.6" rx="15" />
                    {/* Arms */}
                    <rect x="10" y="55" width="15" height="25" fill="hsl(var(--primary))" opacity="0.6" rx="7" />
                    <rect x="55" y="55" width="15" height="25" fill="hsl(var(--primary))" opacity="0.6" rx="7" />
                    {/* Legs */}
                    <rect x="30" y="90" width="8" height="30" fill="hsl(var(--primary))" opacity="0.6" rx="4" />
                    <rect x="42" y="90" width="8" height="30" fill="hsl(var(--primary))" opacity="0.6" rx="4" />
                  </g>

                  {/* Chat/communication bubbles */}
                  <g transform="translate(280, 40)">
                    <ellipse cx="30" cy="20" rx="25" ry="15" fill="hsl(var(--primary))" opacity="0.3" />
                    <ellipse cx="35" cy="45" rx="20" ry="12" fill="hsl(var(--primary))" opacity="0.2" />
                  </g>

                  {/* Security/privacy icons */}
                  <g transform="translate(320, 180)">
                    <rect x="0" y="10" width="25" height="20" fill="hsl(var(--primary))" opacity="0.4" rx="3" />
                    <rect
                      x="5"
                      y="5"
                      width="15"
                  ...
                  <g transform="translate(80, 180)">
                    <circle
                      ...
                      opacity="0.6"
                    />
                    <line x1="20" y1="20" x2="20" y2="10" stroke="hsl(var(--primary))" strokeWidth="2" opacity="0.8" />
                    <line x1="20" y1="20" x2="28" y2="20" stroke="hsl(var(--primary))" strokeWidth="2" opacity="0.8" />
                  </g>

                  {/* Floating elements for animation */}
                  <circle cx="350" cy="100" r="4" fill="hsl(var(--primary))" opacity="0.3" className="animate-float" />
                  <circle
                    cx="80"
                    cy="40"
                    r="3"
      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Why Choose A Safe Space to Talk?</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A secure, professional platform designed for meaningful private conversations and sessions.
            </p>
          </div>
            ...
            <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-primary/60 flex items-center justify-center">
                <div className="text-center text-primary-foreground">
                  <h3 className="text-2xl md:text-3xl font-bold mb-2">Professional Environment</h3>
                  <p className="text-lg opacity-90">Designed for meaningful conversations</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-border/50 hover:border-primary/20 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in-up animation-delay-200">
              <CardHeader>
                ...
                <CardDescription>
                  Simple, intuitive booking system that lets you schedule sessions quickly and efficiently.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border/50 hover:border-primary/20 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in-up animation-delay-400">
              <CardHeader>
                ...
                <CardDescription>
                  Book sessions that fit your schedule, with multiple time slots available throughout the week.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border/50 hover:border-primary/20 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in-up animation-delay-600">
              <CardHeader>
                ...
                <CardDescription>
                  One-on-one focused sessions tailored to your specific needs and goals.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border/50 hover:border-primary/20 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in-up animation-delay-800">
              <CardHeader>
                ...
                <CardDescription>
                  Receive immediate booking confirmation with all session details and reminders.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border/50 hover:border-primary/20 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in-up animation-delay-1000">
              <CardHeader>
                ...
                <CardDescription>
                  Professional service with a commitment to excellence in every session.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Easy Online Booking</h3>
              <p className="text-muted-foreground">
                Our intuitive booking system makes it simple to schedule your sessions. Choose your preferred time,
                confirm your booking, and receive instant confirmation - all from the comfort of your home.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            <div className="group hover:scale-105 transition-transform duration-300">
              ...
              <CardDescription>Select from available time slots that work best for your schedule.</CardDescription>
            </div>
            ...
            <div className="group hover:scale-105 transition-transform duration-300">
              ...
              <CardDescription>Complete your booking with our secure and simple reservation system.</CardDescription>
            </div>
            ...
            <div className="group hover:scale-105 transition-transform duration-300">
              ...
              <CardDescription>
                Join your private session at the scheduled time in our secure environment.
              </CardDescription>
            </div>
          </div>
        </div>
            ...
            <div className="relative h-48 md:h-64 rounded-2xl overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-transparent flex items-end justify-center pb-8">
                <div className="text-center">
                  ...
                  <p className="text-lg font-semibold text-foreground">4.9/5 Average Rating</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-border/50 hover:scale-105 transition-all duration-300 hover:shadow-lg animate-fade-in-up">
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  "The booking system is incredibly easy to use. I was able to schedule my session in just a few clicks,
                  and the whole process was seamless."
                </CardDescription>
            ...
            <Card className="border-border/50 hover:scale-105 transition-all duration-300 hover:shadow-lg animate-fade-in-up animation-delay-200">
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  "Privacy and confidentiality were my main concerns, and this platform exceeded my expectations. I felt
                  completely secure throughout."
                </CardDescription>
                <div className="mt-4 flex items-center space-x-3">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
            ...
            <Card className="border-border/50 hover:scale-105 transition-all duration-300 hover:shadow-lg animate-fade-in-up animation-delay-400">
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  "The flexibility in scheduling is amazing. I can book sessions that fit perfectly with my busy
                  schedule, even last minute."
                </CardDescription>
                <div className="mt-4 flex items-center space-x-3">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
      ...
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-foreground">Flexible Pricing Options</h3>
              <p className="text-muted-foreground">
                We believe in transparent pricing that works for everyone. Whether you need a single session or prefer
                ongoing support, we have options that fit your needs and budget.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-border/50 relative hover:scale-105 transition-all duration-300 hover:shadow-lg animate-fade-in-up">
              <CardHeader className="text-center">
                ...
                <CardDescription className="mt-2">Perfect for trying out our service</CardDescription>
              </CardHeader>
              <div className="px-6 pb-6">
                ...
                <Button className="w-full mt-6 hover:scale-105 transition-transform duration-200">
                  Book Single Session
                </Button>
              </div>
            </Card>
            ...
            <Card className="border-primary/50 relative hover:scale-105 transition-all duration-300 hover:shadow-xl animate-fade-in-up animation-delay-200">
              ...
              <CardHeader className="text-center">
                ...
                <CardDescription className="mt-2">3 sessions - Save $25</CardDescription>
              </CardHeader>
              <div className="px-6 pb-6">
                <ul className="space-y-3">
                  <li className="flex items-center">
                ...
                <Button className="w-full mt-6 hover:scale-105 transition-transform duration-200">Get Package</Button>
              </div>
            </Card>
            ...
            <Card className="border-border/50 relative hover:scale-105 transition-all duration-300 hover:shadow-lg animate-fade-in-up animation-delay-400">
              <CardHeader className="text-center">
                ...
                <CardDescription className="mt-2">4 sessions per month - Best value</CardDescription>
              </CardHeader>
              <div className="px-6 pb-6">
                <ul className="space-y-3">
                  <li className="flex items-center">
      ...
      <section className="py-20 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
            Take the next step and book your private session today. Simple, secure, and confidential.
          </p>
          <Button
            size="lg"
            variant="secondary"
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground mb-6 max-w-md">
                Private 1-on-1 sessions in a safe, confidential environment. Easy booking for your convenience.
              </p>
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-muted-foreground">hello@safespacetotak.com</span>
                </div>
                <div className="flex items-center space-x-3">
